import { Title, Container, Image, Info, Subtitle, DetailBox, Production, Release, Label, TagList, Tag, Rating, StarRating, VoteCount, OutOf, Description, Star } from "./styled";
        ...
        <Container>
            ...
            <Info>
                ...
                <Rating>
                    ...
                    <StarRating>{useCommaToRating(rating)}<OutOf> /10</OutOf></StarRating>
