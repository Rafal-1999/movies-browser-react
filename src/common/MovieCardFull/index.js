import { Title, Container, Image, Info, Subtitle, DetailBox, Production, Release, Label, TagList, Tag, Rating, StarRating, VoteCount, OutOf } from "./styled";

const MovieCardFull = ({ image, title, production, release, tags, rating, voteCount }) => {
    return (
        <Container>
            <Image src={image} />
            <Info>
                ...
                <Rating>
                    ...
                    <StarRating>{rating} <OutOf></OutOf></StarRating>
